        ...
        .click(function (event) {
            ...
            if ($(".app").hasClass("sidenav-toggled")) {
                ...
                if (
                    ...
                    !document
                        .querySelector("html")
                        .getAttribute("data-layout") === "horizontal"
                ) {
                    if (
                        ...
                        var sidemenuActive = document.querySelector(
                            ".side-menu__item.active"
                        );
                        if (sidemenuActive?.nextElementSibling) {
                            var submenu = sidemenuActive.nextElementSibling;
...
function doubleLayoutFn() {
    ...
    if (document.querySelector(".slide-menu") && innerWidth >= 992) {
        var sidemenuActive = document.querySelector(
            ".side-menu__item.is-expanded"
        );
        if (sidemenuActive?.nextElementSibling) {
            document.body.classList.remove("sidenav-toggled");
        }

        var doubleActive = document.querySelectorAll(".double-menu-active");
        if (doubleActive.length) {
            doubleActive.forEach((e) =>
                e.classList.remove("double-menu-active")
            );
        }
    }
...
function icontext() {
    ...
    var alterClass = function () {
        ...
        if (ww < 992) {
            ...
            ww >= 991 &&
            !(document.querySelector(".horizontal") !== null)
        ) {
...
function slideClick() {
    ...
    var slideMenu = document.querySelectorAll(".slide-menu");
...
var menuWidth = document.querySelector(".horizontal-main");
var menuItems = document.querySelector(".side-menu");

$(window).resize(() => {
    var menuWidth = document.querySelector(".horizontal-main");
    var menuItems = document.querySelector(".side-menu");
    var mainSidemenuWidth = document.querySelector(".main-sidemenu");
    var menuContainerWidth =
        menuWidth?.offsetWidth - mainSidemenuWidth?.offsetWidth;
    var marginLeftValue = Math.ceil(
        window.getComputedStyle(menuItems).marginLeft.split("px")[0]
    );
    var marginRightValue = Math.ceil(
...
function ActiveSubmenu() {
    ...
    $(".app-sidebar li a").each(function () {
        ...
        var prevValue = [window.innerWidth];
...
$(document).on("click", "#slide-left", function () {
    ...
    if (!(html.getAttribute("dir") === "rtl")) {
        ...
        var subNavSub = document.querySelectorAll(".sub-nav-sub");
        subNavSub.forEach((e) => {
            e.style.display = "";
        });
        var subNav = document.querySelectorAll(".nav-sub");
        subNav.forEach((e) => {
            e.style.display = "";
        });
        //
...
$(document).on("click", "#slide-right", function () {
    var html = document.querySelector("html");
    var menuWidth = document.querySelector(".app-sidebar");
    var menuItems = document.querySelector(".side-menu");
    var mainSidemenuWidth = document.querySelector(".main-sidemenu");
    var menuContainerWidth =
        menuWidth?.offsetWidth - mainSidemenuWidth?.offsetWidth;
