<div>
    ...
    <x-card>
        <div>
            <button type="button" class="btn btn-primary float-end mt-0 mb-2" wire:click="openPackageModal"><span>New Package</span> <em class="icon ni ni-arrow-long-right"></em></button></li>
        </div>
        ...
        <x-modal id="PackageModal" title="{{$package_id ? 'Update' : 'Create'}} Package" footer="button">
            ...
            <x-slot name="footer">
                <x-button.default class="btn btn-success" type="button" wire:click="storePackage" wire:target="storePackage">Save</x-button.default>
            </x-slot>
        </x-modal>
    </x-card>
</div>
