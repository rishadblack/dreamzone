<div class="form-group">
    ...
    <div wire:ignore>
        <select id="{{ $attributes->wire('model')->value }}" name="{{ $attributes->wire('model')->value }}" @isset($attributes['multiple']) multiple="multiple" @endisset  class="form-control {{ $attributes['class'] }}" {{ $attributes->wire('model')}}>
