...
class SponsorIncomeReportTable extends DataTableComponent
{
    protected $index = 0;
    ...
    {
        $Income =  Income::query()->with('Parent:id,name,username')->whereType(1);
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Refer Name", "Parent.name")->searchable()->sortable(),
            Column::make("Refer ID", "Parent.username")->searchable()->sortable(),
